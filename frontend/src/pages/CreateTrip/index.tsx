...
export const CreateTrip = () => {
    ...
    const createTrip = async (event: FormEvent<HTMLFormElement>) => {
        ...
        const response = await api.post('/trips', {
            destination,
            startsAt: startAndEndDates?.from,
            endsAt: startAndEndDates?.to,
    ...
    return (
        <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
            ...
            <ConfirmTripCreationModal destination={destination} startsAt={startAndEndDates?.from} endsAt={startAndEndDates?.to} isOpen={isConfirmInviteModalOpen} onClose={handleConfirmInviteModal} createTrip={createTrip} />
        </div>
