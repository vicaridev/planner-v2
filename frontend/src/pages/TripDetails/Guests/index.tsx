...
export const Guests = () => {
    ...
    return (
        <div className="space-y-6">
                                        ...
                                        return (
                                            <div key={guest.id} className="flex items-start justify-between">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    {guest.isConfirmed ? (<CheckCircle2 className="text-green-400 size-5" />) : (<CircleDashed className="text-zinc-400 size-5" />)}
            ...
            <Button variant="secondary_text" size="full" onClick={handleGuestModal}>
